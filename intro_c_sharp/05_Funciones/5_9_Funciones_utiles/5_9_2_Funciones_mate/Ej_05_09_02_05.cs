/* (5.9.2.5) Crea un programa que pida al usuario 5 datos numéricos
 * reales,los guarde en un array, pida un nuevo dato y muestre el valor
 * del array que se encuentra más cerca de ese dato en valor absoluto
 * (es decir, el más próximo, sea mayor que él o menor que él).
 */
 using System;
 ...
 public class Ejercicio_5_9_2_4
 {
	 ...
	 public static int NumeroMasCercano(int[] arrayNumeros,
	  int numeroUsuario)
	 {
		 int i;
		 ...
		 for(i = 0; i < arrayNumeros.Length; i++)
		 {
			 ...
			 //Busco los mayores
			 if(Math.Abs(arrayNumeros[i]) > numeroUsuario)
			 {
	 ...
	 public static void Main()
	 {
		 ...
		 Console.WriteLine("Ingrese otro número para saber cuál es" +
		 ...
		 numeroMayorCercano = NumeroMasCercano(arrayEnteros,
		  numeroUsuario);
		 ...
		 {
			 Console.WriteLine("El número más cercano en valor absoluto"
			  + " es {0}", numeroMayorCercano);			 
		 }
