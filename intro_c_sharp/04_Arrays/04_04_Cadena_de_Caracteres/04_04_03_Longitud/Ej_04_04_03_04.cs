/*(4.4.3.4) Un programa capaz de sumar dos números enteros muy grandes
 * (por ejemplo, de 30 cifras), que se deberán pedir como cadena
 * de texto y analizar letra a letra.
 */
 using System;
 ...
 public class Ejercicio_4_4_3_4
 {
	 public static void Main()
	 {
		 ...
		 for(i = longitud-1; i >= 0; i--)
		 {
			 ...
			 numeroEnteroDos = Convert.ToInt32(numeroDos[i].ToString());
