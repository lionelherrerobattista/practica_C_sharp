/*(4.6.8) Mejorar la base de datos de ficheros (ejemplo 04_06a)
 * para que se pueda modificar un cierto dato a partir de su número
 * (por ejemplo, el dato número 3). En esa modificación,
 * se deberá permitir al usuario pulsar Intro sin teclear nada,
 * para indicar que no desea modificar un cierto dato,
 * en vez de reemplazarlo por una cadena vacía.
 */
 using System;
