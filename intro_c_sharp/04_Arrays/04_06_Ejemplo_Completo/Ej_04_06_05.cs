/*(4.6.5) Ampliar la base de datos de ficheros (ejemplo 04_06a)
 * para que incluya una opción de búsqueda parcial,
 * en la que el usuario indique parte del nombre
 * y se muestre todos los ficheros que contienen ese fragmento
 * (usando "Contains" o "IndexOf"). Esta búsqueda no debe distinguir
